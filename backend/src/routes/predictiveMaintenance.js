...
// Predictive maintenance based on telemetry signatures
...
router.get('/info', authenticateToken, (req, res) => {
  res.json({ feature: 'predictive-maintenance', title: 'Predictive maintenance based on telemetry signatures', project: 'AIVendingMachineNetworkManager' });
});
